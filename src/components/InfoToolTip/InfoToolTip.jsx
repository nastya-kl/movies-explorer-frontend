...
function InfoToolTip({ title, isOpen, isCorrect, onClose }) {
  ...
  return (
    <div className={`tool-tip ${isOpen ? 'tool-tip_visibility_true' : ''}`} onMouseDown={handleOverlay}>
      <div className="tool-tip__container">
        <div className={`tool-tip__icon ${isCorrect ? 'tool-tip__icon_type_success' : 'tool-tip__icon_type_not-success'}`}></div>
